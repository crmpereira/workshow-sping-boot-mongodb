...
public class Instatiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "PartiuViagem", "Vou Viajar para Sao Paulo Abraços.", maria );
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bom Dia", "Vou Acordei feliz.", maria );
